...
class MyVgg11Net(BasicModule):
    def __init__(self):
        super(MyVgg11Net, self).__init__()
    ...
    def forward(self, x):
        ...
        return x
class MyVgg13Net(BasicModule):
    def __init__(self):
        super(MyVgg13Net, self).__init__()
...
class MyVgg16Net(BasicModule):
    ...
    def forward(self, x):
        ...
        return x
class MyVgg19Net(BasicModule):
    def __init__(self):
        super(MyVgg19Net, self).__init__()
